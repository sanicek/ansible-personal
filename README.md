...
scripts/validate.sh arch_gz302ea_audio
```
...
ansible-playbook ansible_collections/sanicek/personal/playbooks/arch_gz302ea_audio.yml --syntax-check
...
molecule test -s arch_gz302ea_audio
```
